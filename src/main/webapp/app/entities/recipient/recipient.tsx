...
import { getSearchEntities, getEntities } from './recipient.reducer';
...
export class Recipient extends React.Component<IRecipientProps, IRecipientState> {
    ...
    return (
      <div>
        <h2 id="recipient-heading">
          <Translate contentKey="storeHouseApp.recipient.home.title">Recipients</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeHouseApp.recipient.home.createLabel">Create new Recipient</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('storeHouseApp.recipient.home.search')}
                  />
