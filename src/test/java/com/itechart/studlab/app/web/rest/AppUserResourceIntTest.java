...
public class AppUserResourceIntTest {
     ...
     *
     * @see com.itechart.studlab.app.repository.search.AppUserSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createAppUser() throws Exception {
        ...
        assertThat(testAppUser.isIsSuspended()).isEqualTo(DEFAULT_IS_SUSPENDED);
        assertThat(testAppUser.getMoney()).isEqualTo(DEFAULT_MONEY);
    ...
    public void updateAppUser() throws Exception {
        ...
        assertThat(testAppUser.isIsSuspended()).isEqualTo(UPDATED_IS_SUSPENDED);
        assertThat(testAppUser.getMoney()).isEqualTo(UPDATED_MONEY);
