...
export interface ICompaniesUpdateState {
  isNew: boolean;
}

export class CompaniesUpdate extends React.Component<ICompaniesUpdateProps, ICompaniesUpdateState> {
  state: ICompaniesUpdateState = {
  ...
  render() {
    ...
    const { user, loading, updating } = this.props;
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h1>
              <Translate contentKey="companies.home.createOrEditLabel">Create or edit a company</Translate>
            </h1>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm onValidSubmit={this.saveUser}>
                <AvGroup>
                  ...
                  <AvField type="text" className="form-control" name="company" value={user.company} />
                </AvGroup>
                <AvGroup check>
                  <AvInput type="checkbox" name="activated" value={user.activated} />
                  <Label check for="activated">
                ...
                <AvGroup>
                  <AvField
                    ...
                    placeholder={translate('companies.email')}
                    type="email"
                    validate={{
                      required: {
                        value: true,
                ...
                <AvGroup>
                  <Label for="birthdate">
                    <Translate contentKey="userManagement.birthdate">Birthdate</Translate>
                  </Label>
                  <AvField
                    type="date"
                    className="form-control"
                    ...
                    validate={{
                      ...
                      dateRange: {
                        ...
                        errorMessage: translate('entity.validation.age', { min: 18, max: 70 })
                      }
                    }}
                ...
                <AvGroup>
                  ...
                  <AvInput name="city" type="text" className="form-control" value={user.city} />
                </AvGroup>
                <AvGroup>
                  <Label for="address">
...
const mapDispatchToProps = { getUser, updateUser, createUser, reset };
