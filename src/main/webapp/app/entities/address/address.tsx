    ...
    return (
      <div>
        <h2 id="address-heading">
          <Translate contentKey="storeHouseApp.address.home.title">Addresses</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeHouseApp.address.home.createLabel">Create new Address</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('storeHouseApp.address.home.search')}
                  />
            ...
            <tbody>
              {addressList.map((address, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{address.userName ? <Link to={`app-user/${address.userId}`}>{address.userName}</Link> : ''}</td>
