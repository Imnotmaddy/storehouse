...
public class StorageRoomResource {
    ...
    public ResponseEntity<StorageRoomDTO> createStorageRoom(@Valid @RequestBody StorageRoomDTO storageRoomDTO) throws URISyntaxException {
    ...
    public ResponseEntity<StorageRoomDTO> updateStorageRoom(@Valid @RequestBody StorageRoomDTO storageRoomDTO) throws URISyntaxException {
