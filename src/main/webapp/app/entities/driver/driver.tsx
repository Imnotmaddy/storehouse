    ...
    return (
      <div>
        <h2 id="driver-heading">
          <Translate contentKey="storeHouseApp.driver.home.title">Drivers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeHouseApp.driver.home.createLabel">Create new Driver</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('storeHouseApp.driver.home.search')}
                  />
