...
export class AppUser extends React.Component<IAppUserProps, IAppUserState> {
  state: IAppUserState = {
    search: ''
  };
    ...
    return (
      <div>
        <h2 id="app-user-heading">
          <Translate contentKey="storeHouseApp.appUser.home.title">App Users</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeHouseApp.appUser.home.createLabel">Create new App User</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('storeHouseApp.appUser.home.search')}
                  />
            ...
            <tbody>
              {appUserList.map((appUser, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={appUser.birthdate} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
                  <td>{appUser.isSuspended ? 'true' : 'false'}</td>
                  <td>{appUser.money}</td>
