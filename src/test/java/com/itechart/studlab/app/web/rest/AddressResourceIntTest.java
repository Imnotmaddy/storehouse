...
import com.itechart.studlab.app.repository.AddressRepository;
import com.itechart.studlab.app.repository.search.AddressSearchRepository;
import com.itechart.studlab.app.service.AddressService;
import com.itechart.studlab.app.service.dto.AddressDTO;
import com.itechart.studlab.app.service.mapper.AddressMapper;
...
public class AddressResourceIntTest {
     ...
     *
     * @see com.itechart.studlab.app.repository.search.AddressSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAddress() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses/{id}", address.getId()))
            ...
            .andExpect(jsonPath("$.apartmentNumber").value(DEFAULT_APARTMENT_NUMBER));
    }
