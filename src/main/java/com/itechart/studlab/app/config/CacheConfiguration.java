...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.itechart.studlab.app.domain.Driver.class.getName(), jcacheConfiguration);
            cm.createCache(com.itechart.studlab.app.domain.Transporter.class.getName(), jcacheConfiguration);
            cm.createCache(com.itechart.studlab.app.domain.Recipient.class.getName(), jcacheConfiguration);
            cm.createCache(com.itechart.studlab.app.domain.Sender.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.itechart.studlab.app.domain.Address.class.getName(), jcacheConfiguration);
            cm.createCache(com.itechart.studlab.app.domain.AppUser.class.getName(), jcacheConfiguration);
