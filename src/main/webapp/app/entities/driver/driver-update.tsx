    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="storeHouseApp.driver.home.createOrEditLabel">
              <Translate contentKey="storeHouseApp.driver.home.createOrEditLabel">Create or edit a Driver</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : driverEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="driver-name" type="text" name="name" />
                </AvGroup>
                <AvGroup>
                  <Label id="passportIdLabel" for="passportId">
                    <Translate contentKey="storeHouseApp.driver.passportId">Passport Id</Translate>
                  </Label>
                  <AvField id="driver-passportId" type="text" name="passportId" />
                </AvGroup>
                <AvGroup>
                  <Label id="citizenshipLabel" for="citizenship">
                    <Translate contentKey="storeHouseApp.driver.citizenship">Citizenship</Translate>
                  </Label>
                  <AvField id="driver-citizenship" type="text" name="citizenship" />
                </AvGroup>
