...
export class RecipientUpdate extends React.Component<IRecipientUpdateProps, IRecipientUpdateState> {
  ...
  render() {
    const { recipientEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="storeHouseApp.recipient.home.createOrEditLabel">
              <Translate contentKey="storeHouseApp.recipient.home.createOrEditLabel">Create or edit a Recipient</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : recipientEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="recipient-companyName" type="text" name="companyName" />
                </AvGroup>
