...
public class DriverResourceIntTest {
     ...
     *
     * @see com.itechart.studlab.app.repository.search.DriverSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createDriver() throws Exception {
        ...
        assertThat(testDriver.getPassportId()).isEqualTo(DEFAULT_PASSPORT_ID);
        assertThat(testDriver.getCitizenship()).isEqualTo(DEFAULT_CITIZENSHIP);
    ...
    public void getAllDrivers() throws Exception {
        ...
        restDriverMockMvc.perform(get("/api/drivers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].passportId").value(hasItem(DEFAULT_PASSPORT_ID.toString())))
    ...
    public void getDriver() throws Exception {
        ...
        restDriverMockMvc.perform(get("/api/drivers/{id}", driver.getId()))
            ...
            .andExpect(jsonPath("$.passportId").value(DEFAULT_PASSPORT_ID.toString()))
    ...
    public void updateDriver() throws Exception {
        ...
        assertThat(testDriver.getPassportId()).isEqualTo(UPDATED_PASSPORT_ID);
        assertThat(testDriver.getCitizenship()).isEqualTo(UPDATED_CITIZENSHIP);
