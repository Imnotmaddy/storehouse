...
export class StorehouseDeleteDialog extends React.Component<IStorehouseDeleteDialogProps> {
  componentDidMount() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-storehouse" color="danger" onClick={this.confirmDelete}>
